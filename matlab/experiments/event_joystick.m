...
for i = 1:size(all_data,1)
    ...
    if ~isempty(pfile)
        ...
        [gs_events.w1abs, gs_events.w1var, gs_events.w1slp, gs_events.w1slp2] = ...
            extract_joystick(pfile.joystick, gs_events(:, 'timestamp_ms'), 3750, 3750);
        [gs_events.w2abs, gs_events.w2var, gs_events.w2slp, gs_events.w2slp2] = ...
            extract_joystick(pfile.joystick, gs_events(:, 'timestamp_ms'), 7500, 7500);
        [gs_events.w3abs, gs_events.w3var, gs_events.w3slp, gs_events.w3slp2] = ...
            extract_joystick(pfile.joystick, gs_events(:, 'timestamp_ms'), 10000, 10000);
        [gs_events.w4abs, gs_events.w4var, gs_events.w4slp, gs_events.w4slp2] = ...
            extract_joystick(pfile.joystick, gs_events(:, 'timestamp_ms'), 3000, 12000);
